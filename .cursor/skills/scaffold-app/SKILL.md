...
To override defaults locally, copy the env template (`.cursor/skills/scaffold-app/templates/env.example` → repo-root `.env`; see the `platform` rule for the OS-specific copy command).
